# Regular Expressions Tutorial For Email Format
...
This tutorial will follow the different components of regular expressions. 
...
The following code can be used for matching emails. 
One use for this code is that it can be used to validate to make sure that an email follows the correct format. 
...
### Flags
A regex flag is not used in the matching email code that is being used for this tutorial. 
A regular expression typically comes in the form:
...
This Tutorial was created by Nelson Roberts.

Contact Info Below:

[GitHub](https://github.com/nelsonRoberts1968)

[Email](nellyroberts1968@gmail.com)

[LinkedIn](https://www.linkedin.com/in/nelson-mmbando-8255a5110/)